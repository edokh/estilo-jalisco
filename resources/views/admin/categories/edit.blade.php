...
<div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data"
        ...
        <div>
            ...
            <textarea name="description" rows="4" class="w-full px-4 py-2 border rounded">{{ old('description', $category->description) }}</textarea>
        ...
        <div>
            ...
            <input type="number" name="order" value="{{ old('order', $category->order) }}" class="w-full px-4 py-2 border rounded">
